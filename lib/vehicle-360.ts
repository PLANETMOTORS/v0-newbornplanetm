...
export const DRIVEE_VIN_MAP: Record<string, string> = {
  // ── Active inventory (verified via Pirelly API 2026-04-17) ──────────
  ...
  "5YJ3E1EA3MF848712": "132601940353",  // 2021 Tesla Model 3 — mint green
  // "LRW3E1EBXPC876367" removed — was sharing 2021 Model 3 photos (needs own Drivee shoot)
  ...
  "5YJ3E1EC5NF234540": "061789806057",  // 2022 Tesla Model 3
  ...
  // "3VV4B7AX1SM019897" removed — VW VIN was incorrectly mapped to Chevy Equinox photos
  // "5YJ3E1EB4MF062024" removed — was sharing 2021 Model 3 photos (different vehicle)

  // ── Not yet photographed with Drivee (no MID in Pirelly API) ────────
  // "LRW3E7EB6RC102901":  null,  // 2024 Tesla Model 3
  // "7SAYGDEE9PF600377":  null,  // 2023 Tesla Model Y
  // "7SAYGAEE2NF381838":  null,  // 2022 Tesla Model Y
  // "5YJYGDED2MF121136":  null,  // 2021 Tesla Model Y
  // "LRW3E7FA5RC089290":  null,  // 2024 Tesla Model 3
  // "7SAYGAEE0NF323551":  null,  // 2022 Tesla Model Y
  // "5YJSA1E64NF476477":  null,  // 2022 Tesla Model S Plaid
  // "7SAYGDEF1NF374938":  null,  // 2022 Tesla Model Y
  // "LRW3E1EB3PC943116":  null,  // 2023 Tesla Model 3
}
