...
// All GROQ queries are inlined to avoid module resolution issues
...
const SELL_YOUR_CAR_PAGE_QUERY = `
  *[_type == "sellYourCar"][0] {
...
const INVENTORY_SETTINGS_QUERY = `
...
const VEHICLES_BY_STOCK_NUMBERS_QUERY = `
