...
// Extracted to reduce structural duplication while maintaining readability

const gapCoverageData = {
  slug: "gap-coverage",
  ...
  icon: Shield,
  heroDescription: "If your vehicle is totaled or stolen, your insurance pays the current market value — but that's often less than what you owe on your loan. Companion GAP Coverage bridges the gap so you're never stuck paying for a car you can't drive.",
  howItWorks: [
  ...
  covered: ["Difference between insurance payout and loan/lease balance", "Theft or total loss due to collision, fire, or other covered peril", "Lease gap amount if applicable", "Coverage for the full length of your loan or lease", "Automatic attachment to your financing agreement"],
  notCovered: ["Deductibles on your insurance policy", "Missed or late loan payments", "Regular maintenance or mechanical repairs", "Voluntary surrender of the vehicle", "Negative equity rolled over from a previous loan"],
  benefits: [
  ...
  seo: { title: "Companion GAP Coverage | Protect Your Auto Loan | Planet Motors", description: "GAP insurance covers the difference between your car's value and what you owe. Protect yourself from financial loss after a total loss or theft. Available at Planet Motors Richmond Hill.", keywords: ["GAP insurance Canada", "GAP coverage Ontario", "auto loan protection", "negative equity protection", "Planet Motors GAP"] },
}
...
const extendedWarrantyData = {
  ...
  covered: ["Engine and transmission components", "Electrical systems and wiring", "Heating and air conditioning", "Steering and suspension", "Fuel delivery and emissions systems", "Braking system components", "24/7 roadside assistance", "Rental car reimbursement", "Trip interruption coverage"],
  notCovered: ["Pre-existing conditions at time of purchase", "Regular maintenance items (oil, filters, brake pads)", "Cosmetic damage or wear items", "Damage from accidents or misuse", "Modifications or aftermarket parts"],
  benefits: [
  ...
  seo: { title: "Extended Vehicle Warranty | Mechanical Breakdown Protection | Planet Motors", description: "Protect your used car with an extended warranty from Planet Motors. Covers engine, transmission, electrical, A/C, and more. Zero deductible options available in Richmond Hill, Ontario.", keywords: ["extended car warranty Canada", "used car warranty Ontario", "mechanical breakdown protection", "vehicle service contract", "Planet Motors warranty"] },
}

const incidentProData = {
  slug: "incident-pro",
  ...
  icon: Car,
  heroDescription: "Accidents happen. When they do, IncidentPro ensures your vehicle is replaced — not just insured. Get new-for-old replacement coverage, job loss protection, and payment coverage during disability, all in one plan.",
  howItWorks: [
  ...
  covered: ["New-for-old vehicle replacement up to $60,000", "Total loss from collision or accident", "Theft and attempted theft", "Fire, flood, and natural disaster damage", "Job loss payment protection (up to 12 months)", "Disability payment coverage", "Loan clearance on death or critical illness"],
  notCovered: ["Mechanical breakdowns (covered by Extended Warranty)", "Cosmetic damage that doesn't affect drivability", "Intentional damage or fraud", "Driving under the influence incidents", "Vehicles used for commercial purposes without disclosure"],
  benefits: [
  ...
  seo: { title: "IncidentPro Vehicle Protection | Replacement Coverage | Planet Motors", description: "IncidentPro provides new-for-old vehicle replacement, job loss protection, and critical illness loan clearance. Superior to traditional insurance. Planet Motors Richmond Hill.", keywords: ["vehicle replacement coverage", "total loss protection Canada", "job loss car payment protection", "IncidentPro", "Planet Motors protection"] },
}
...
const antiTheftData = {
  ...
  icon: LockKeyhole,
  heroDescription: "Vehicle theft in Canada has surged 34% since 2021. InvisiTrak provides invisible GPS tracking, 24/7 professional monitoring, and rapid police coordination — giving you the best chance of recovering your vehicle if it's stolen.",
  howItWorks: [
  ...
  covered: ["Professional concealed GPS device installation", "24/7 satellite-based GPS tracking", "Real-time mobile app alerts and notifications", "Unauthorized movement detection", "Direct police coordination for rapid recovery", "Battery backup — works even if car battery is disconnected", "Coverage across Canada and the US"],
  notCovered: ["Vehicle damage that occurs during theft", "Personal belongings stolen from the vehicle", "Tracking in areas without cellular coverage", "Physical damage to the tracking device from accidents"],
  benefits: [
  ...
  seo: { title: "InvisiTrak Anti-Theft GPS Tracking | Vehicle Recovery | Planet Motors", description: "Protect your vehicle with InvisiTrak GPS tracking and 24/7 monitoring. Concealed installation, rapid police coordination, and mobile alerts. Planet Motors Richmond Hill.", keywords: ["car anti-theft system Canada", "GPS vehicle tracking Ontario", "InvisiTrak", "stolen car recovery", "vehicle security system"] },
}
...
const paintProtectionData = {
  ...
  icon: PaintBucket,
  heroDescription: "Your vehicle's paint is under constant assault — road debris, gravel, UV rays, bird droppings, and harsh Canadian winters. Our Paint Protection Film (PPF) creates an invisible, self-healing barrier that keeps your finish showroom-perfect for years.",
  howItWorks: [
  ...
  covered: ["Rock chips and road debris impact", "Scratches from minor contact", "UV damage and oxidation prevention", "Bug splatter and bird dropping stains", "Road salt and chemical damage", "Self-healing technology for minor swirl marks", "Professional installation warranty"],
  notCovered: ["Deep scratches or dents from collisions", "Pre-existing paint damage or imperfections", "Damage from power washers at close range", "Film degradation from improper maintenance"],
  benefits: [
  ...
  seo: { title: "Paint Protection Film (PPF) | Self-Healing Clear Bra | Planet Motors", description: "Protect your car's paint with premium paint protection film. Self-healing technology, UV protection, and invisible armor against chips and scratches. Planet Motors Richmond Hill.", keywords: ["paint protection film Canada", "PPF Ontario", "clear bra car", "self-healing film", "car paint protection Richmond Hill"] },
}

const replacementWarrantyData = {
  ...
  icon: Sparkles,
  heroDescription: "If your vehicle is written off, standard insurance gives you its depreciated value — often thousands less than what you paid. Our Replacement Warranty Plan replaces your vehicle with one of comparable value, so you're never left short.",
  howItWorks: [
  ...
  covered: ["New-for-old replacement up to covered value", "Total loss from collision or accident", "Theft where vehicle is not recovered", "Fire, vandalism, and natural disaster", "Zero deductible on replacement claim"],
  notCovered: ["Partial damage or repairs (covered by warranty)", "Mechanical breakdown (covered by Extended Warranty)", "Depreciation claims without total loss", "Vehicles used for undisclosed commercial purposes"],
  benefits: [
  ...
  seo: { title: "Vehicle Replacement Warranty | New-for-Old Coverage | Planet Motors", description: "Get new-for-old vehicle replacement if your car is written off. Zero deductible, transferable coverage. Better than insurance depreciation payouts. Planet Motors Richmond Hill.", keywords: ["vehicle replacement warranty", "new for old car replacement", "total loss protection Ontario", "car replacement coverage Canada"] },
}

const rustProtectionData = {
  ...
  icon: Droplets,
  heroDescription: "Canadian roads are treated with millions of tonnes of salt every winter. Without protection, that salt attacks your vehicle's undercarriage, wheel wells, and body panels — causing rust that destroys structural integrity and resale value. Our rust protection coating creates a permanent barrier.",
  howItWorks: [
  ...
  covered: ["Full undercarriage rust protection coating", "Wheel well and fender protection", "Exposed metal surface treatment", "Salt and moisture barrier application", "Professional-grade rust inhibitor", "Application warranty against peeling or cracking"],
  notCovered: ["Pre-existing rust damage or corrosion", "Cosmetic body panel rust (surface only)", "Damage from off-road use or impacts", "Areas not accessible during standard application"],
  benefits: [
  ...
  seo: { title: "Rust Protection Coating & Undercoating | Canadian Winter Ready | Planet Motors", description: "Professional rust protection coating and undercoating for Canadian winters. Prevent road salt corrosion and preserve your vehicle's structural integrity. Planet Motors Richmond Hill.", keywords: ["rust protection Canada", "car undercoating Ontario", "rust proofing", "winter car protection", "road salt protection"] },
}
...
const tireRimData = {
  ...
  icon: CircleDot,
  heroDescription: "Canadian roads are tough on tires and rims. Potholes, construction debris, nails, and curb damage can cost hundreds per tire and thousands per rim to replace. Tire & Rim Protection covers these unexpected costs so you're never stranded with a surprise bill.",
  howItWorks: [
  ...
  covered: ["Tire damage from potholes and road hazards", "Nail and puncture damage beyond repair", "Rim damage from curb impact or potholes", "Bent or cracked alloy wheels", "Unlimited claims during coverage period", "No deductible on any claim", "Coverage at any licensed tire retailer"],
  notCovered: ["Normal tire wear from regular driving", "Cosmetic curb rash that doesn't affect function", "Damage from racing or off-road use", "Tires below minimum tread depth at time of damage"],
  benefits: [
  ...
  seo: { title: "Tire and Rim Protection | Pothole & Road Hazard Coverage | Planet Motors", description: "Protect your tires and rims from potholes, nails, and curb damage. No deductible, unlimited claims, any tire shop. Planet Motors Richmond Hill, Ontario.", keywords: ["tire and rim protection Canada", "pothole damage coverage", "wheel protection plan", "road hazard tire coverage Ontario"] },
}
...
const windowTintData = {
  ...
  icon: Sun,
  heroDescription: "Professional window tint does more than look good — it blocks up to 99% of harmful UV rays, reduces interior heat by up to 60%, protects your upholstery from fading, and adds privacy and security. Our premium ceramic tint films are the highest quality available.",
  howItWorks: [
  ...
  covered: ["Premium ceramic window tint film", "UV ray blocking up to 99%", "Infrared heat rejection technology", "Professional bubble-free installation", "Installation warranty against peeling and discolouration", "Compliance with Ontario tint regulations"],
  notCovered: ["Damage from improper cleaning methods", "Scratches from sharp objects", "Film removal and re-application (separate service)", "Tint darkness levels exceeding legal limits"],
  benefits: [
  ...
  seo: { title: "Window Tint Film | Ceramic UV Protection & Privacy | Planet Motors", description: "Premium ceramic window tint installation. Blocks 99% UV rays, reduces heat by 60%, and adds privacy. Legal Ontario compliance. Planet Motors Richmond Hill.", keywords: ["window tint Ontario", "ceramic window film", "car window tinting Richmond Hill", "UV protection window tint Canada"] },
}

// ── Build product array using defineProduct factory ─────────────────────────
export const PROTECTION_PRODUCTS: ProtectionProduct[] = [
  defineProduct(gapCoverageData),
  defineProduct(extendedWarrantyData),
  defineProduct(incidentProData),
  defineProduct(antiTheftData),
  defineProduct(paintProtectionData),
  defineProduct(replacementWarrantyData),
  defineProduct(rustProtectionData),
  defineProduct(tireRimData),
  defineProduct(windowTintData),
]
