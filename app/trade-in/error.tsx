...
export default function TradeInError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    reportError(error, { boundary: "trade-in" })
  }, [error])
    ...
    <div className="min-h-[60vh] bg-background flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-muted-foreground mb-8">
          We ran into an issue with the trade-in form. Your entered information
          may still be saved. Please try again.
        </p>
