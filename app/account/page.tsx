                  ...
                  <CardContent className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="profileLastName" defaultValue="Smith" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input id="profileEmail" className="pl-10" defaultValue="john.smith@example.com" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input id="profilePhone" className="pl-10" defaultValue="(416) 555-0123" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input id="profileAddress" className="pl-10" defaultValue="123 Main St, Toronto, ON" />
                      </div>
                    </div>
