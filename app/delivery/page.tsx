...
type DistanceEntry = { km: number; city: string; province: string }
...
function expandZone(
  ...
  const result: Record<string, DistanceEntry> = {}
  for (const [code, km] of entries) {
    result[code] = { km, city, province }
  }
  return result
}

// These are approximate driving distances in km
const CITY_DISTANCES: Record<string, DistanceEntry> = {
  ...
  ...expandZone([
    ["H2A", 540], ["H2B", 542], ["H2C", 545], ["H2E", 548], ["H2G", 540],
    ["H2H", 538], ["H2J", 535], ["H2K", 532], ["H2L", 530], ["H2M", 545],
    ["H2N", 548], ["H2P", 545], ["H2R", 542], ["H2S", 540], ["H2T", 538],
    ["H2V", 535], ["H2W", 532], ["H2X", 530], ["H2Y", 528], ["H2Z", 530],
    ["H3B", 542], ["H3C", 545], ["H3E", 548], ["H3G", 540], ["H3H", 538],
    ["H3J", 535], ["H3K", 532], ["H3L", 545], ["H3M", 548], ["H3N", 545],
    ["H3P", 542], ["H3R", 540], ["H3S", 538], ["H3T", 535], ["H3V", 532],
    ["H3W", 530], ["H3X", 528], ["H3Y", 530], ["H3Z", 532],
    ["H4A", 545], ["H4B", 548], ["H4C", 545], ["H4E", 542], ["H4G", 540],
    ["H4H", 538], ["H4J", 535], ["H4K", 532], ["H4L", 530], ["H4M", 528],
    ["H4N", 530], ["H4P", 532], ["H4R", 535], ["H4S", 538], ["H4T", 540],
    ["H4V", 542], ["H4W", 545], ["H4X", 548], ["H4Y", 550], ["H4Z", 552],
  ], "Montreal", "QC"),
  ...
  ...expandZone([
    ["V5A", 4420], ["V5B", 4422], ["V5C", 4425], ["V5E", 4428],
    ["V5G", 4430], ["V5H", 4432], ["V5J", 4435],
  ], "Burnaby", "BC"),
  ...expandZone([
    ["V5K", 4438], ["V5L", 4440], ["V5M", 4442], ["V5N", 4445],
    ["V5P", 4448], ["V5R", 4450], ["V5S", 4452], ["V5T", 4455],
    ["V5V", 4458], ["V5W", 4460], ["V5X", 4462], ["V5Y", 4465], ["V5Z", 4468],
  ], "Vancouver", "BC"),
  ...expandZone([
    ["V7A", 4430], ["V7B", 4432], ["V7C", 4435], ["V7E", 4438],
  ], "Richmond", "BC"),
  ...expandZone([
    ["V7G", 4415], ["V7H", 4418], ["V7J", 4420], ["V7K", 4422],
    ["V7L", 4425], ["V7M", 4428], ["V7N", 4430], ["V7P", 4432], ["V7R", 4435],
  ], "North Vancouver", "BC"),
  ...expandZone([
    ["V7S", 4438], ["V7T", 4440], ["V7V", 4442], ["V7W", 4445],
  ], "West Vancouver", "BC"),
