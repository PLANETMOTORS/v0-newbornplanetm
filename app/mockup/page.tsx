...
export default function HomepageMockupV2() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="bg-pm-brand text-white/90 text-sm py-2">
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 bg-white border-b border-pm-border shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <Link href="#" className="px-4 py-2 text-pm-text-secondary hover:text-pm-brand hover:bg-pm-surface-subtle font-medium rounded-lg transition-colors">
              Shop Cars
            </Link>
            <Link href="#" className="px-4 py-2 text-pm-text-secondary hover:text-pm-brand hover:bg-pm-surface-subtle font-medium rounded-lg transition-colors">
              EVs & Hybrids
          ...
          <div className="flex items-center gap-3">
            <button className="hidden sm:block px-4 py-2 text-pm-brand font-medium hover:bg-pm-surface-subtle rounded-lg transition-colors">
              Sign In
            </button>
            ...
            <button 
              className="lg:hidden p-2 hover:bg-pm-surface-light rounded-lg"
          ...
          <div className="lg:hidden fixed inset-0 z-50 bg-white">
            ...
            <nav className="p-4 space-y-2">
              {["Shop Cars", "EVs & Hybrids", "Sell / Trade", "Financing", "How It Works", "Reviews"].map(item => (
                <Link key={item} href="#" className="block px-4 py-3 text-lg font-medium hover:bg-pm-surface-subtle rounded-lg">
                  {item}
                </Link>
              ))}
            </nav>
        ...
        {/* Trust Bar */}
        <div className="bg-pm-surface-subtle border-t border-pm-border">
          <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-center gap-4 md:gap-10 text-sm overflow-x-auto">
            <div className="flex items-center gap-2 whitespace-nowrap">
              <RotateCcw className="w-4 h-4 text-pm-brand" />
              <span className="font-medium">10-Day Returns</span>
            </div>
            <div className="flex items-center gap-2 whitespace-nowrap">
              <CheckCircle className="w-4 h-4 text-pm-brand" />
              <span className="font-medium">210-Point Inspection</span>
            </div>
            <div className="flex items-center gap-2 whitespace-nowrap">
              <Shield className="w-4 h-4 text-pm-brand" />
              <span className="font-medium">No Hidden Fees</span>
            </div>
            <div className="hidden md:flex items-center gap-2 whitespace-nowrap">
              <Truck className="w-4 h-4 text-pm-brand" />
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 md:py-20 lg:py-24 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-[-0.01em] md:tracking-[-0.02em] leading-tight mb-6 text-pm-text-primary">
              ...
              <p className="text-lg md:text-xl text-pm-text-secondary mb-8 max-w-lg mx-auto lg:mx-0">
            ...
            <div className="relative hidden lg:block">
              <div className="aspect-[4/3] bg-white rounded-3xl border border-pm-border shadow-xl flex items-center justify-center overflow-hidden">
                <div className="text-center p-8">
                  <div className="w-32 h-32 mx-auto mb-4 bg-pm-surface-light rounded-full flex items-center justify-center">
                    <Car className="w-16 h-16 text-pm-brand/30" />
                  </div>
                  <p className="text-pm-text-muted">Featured Vehicle Image</p>
                  <p className="text-pm-text-muted text-sm">Tesla, SUV, or Hybrid showcase</p>
                </div>
              </div>
      ...
      <section className="py-8 bg-white border-b border-pm-border">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-3 overflow-x-auto pb-2 scrollbar-hide">
            <span className="text-pm-text-secondary font-medium whitespace-nowrap">Shop by:</span>
            {[
              ...
              <button 
                key={i}
                className="flex items-center gap-2 px-4 py-2 bg-pm-surface-light hover:bg-pm-brand hover:text-white rounded-full text-sm font-medium whitespace-nowrap transition-colors"
              >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-pm-brand mb-2">
                Featured Vehicles
              </h2>
              <p className="text-pm-text-secondary">Quality vehicles ready for delivery</p>
            </div>
            
            {/* Tabs */}
            <div className="flex gap-2 bg-pm-surface-light p-1 rounded-lg">
              {[
                { id: "all", label: "All" },
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                    activeTab === tab.id 
                      ? "bg-white text-pm-brand shadow-sm" 
                      : "text-pm-text-secondary hover:text-pm-brand"
                  }`}
                >
                  {tab.label}
                </button>
              ...
              <div key={car.id} className="group bg-white rounded-xl border border-pm-border overflow-hidden hover:shadow-xl hover:border-[#1e3a8a]/30 transition-all">
                ...
                <div className="relative aspect-[16/10] bg-pm-surface-light">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <Car className="w-12 h-12 mx-auto text-pm-text-muted" />
                      <p className="text-pm-text-muted text-sm mt-2">Vehicle Image</p>
                    </div>
                  </div>
                  {car.badge && (
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <h3 className="font-semibold text-lg text-pm-brand group-hover:text-[#dc2626] transition-colors">
                        {car.year} {car.name}
                      </h3>
                  ...
                  <div className="flex items-end justify-between pt-3 border-t border-pm-border">
                    <div>
      ...
      <section className="py-16 bg-pm-surface-subtle">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-pm-brand mb-4">
              Why Choose Planet Motors?
            </h2>
            <p className="text-pm-text-secondary text-lg max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white p-6 rounded-xl border border-pm-border hover:shadow-lg hover:border-[#1e3a8a]/30 transition-all">
                ...
                <h3 className="font-semibold text-lg text-pm-brand mb-2">{item.title}</h3>
                <p className="text-pm-text-secondary text-sm">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-pm-text-primary">
                Have a Vehicle to Sell or Trade?
              </h2>
              <p className="text-pm-text-secondary text-lg mb-6">
              ...
              <ul className="space-y-3 mb-8">
                {["Instant online offer", "Free vehicle pickup", "Same-day payment available", "No obligation to buy from us"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3">
                    ...
                    <span className="text-pm-text-secondary">{item}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-pm-text-secondary text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <div className="w-16 h-16 mx-auto mb-6 bg-pm-brand rounded-xl flex items-center justify-center">
                  <span className="text-2xl font-bold text-white">{step.num}</span>
                </div>
                <h3 className="text-xl font-semibold mb-3 text-pm-brand">{step.title}</h3>
                <p className="text-pm-text-secondary">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-pm-surface-subtle">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-pm-text-secondary">See what our customers say</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white p-6 rounded-xl border border-pm-border">
                <div className="flex items-center gap-1 mb-4">
                  {[1,2,3,4,5].map(j => (
                    <Star key={j} className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                  ))}
                </div>
                <p className="text-pm-text-secondary mb-4">&quot;{review.text}&quot;</p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-pm-brand rounded-full flex items-center justify-center text-white font-semibold">
                    {review.name.charAt(0)}
                  </div>
                  <div>
                    <div className="font-medium text-pm-brand">{review.name}</div>
                    <div className="text-pm-text-secondary text-sm">{review.location} - {review.car}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* Final CTA */}
      <section className="py-16 bg-pm-brand text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-8 py-4 bg-white text-pm-brand font-semibold rounded-xl hover:bg-pm-surface-light transition-colors">
              Get Pre-Approved
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-pm-text-muted text-sm">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 py-6 border-t border-gray-800">
            <span className="text-pm-text-secondary text-sm">OMVIC Licensed</span>
            <span className="text-pm-text-secondary text-sm">UCDA Member</span>
            <span className="text-pm-text-secondary text-sm">BBB Accredited</span>
          </div>

          <div className="text-center text-pm-text-secondary text-sm pt-6 border-t border-gray-800">
