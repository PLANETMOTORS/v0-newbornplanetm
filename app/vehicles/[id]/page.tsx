...
<main id="main-content" tabIndex={-1} className="pb-32 md:pb-20 overflow-x-hidden max-w-full outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2" aria-label="Vehicle details" data-vin={vehicleData.vin} data-stock={vehicleData.stockNumber}>
  {/* Trade-In Banner */}
