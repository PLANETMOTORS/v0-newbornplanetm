...
<main id="main-content" tabIndex={-1} className="pb-32 md:pb-20 overflow-x-hidden max-w-full outline-none" role="main" aria-label="Vehicle details" data-vin={vehicle.vin} data-stock={vehicle.stockNumber}>
  {/* Trade-In Banner */}
