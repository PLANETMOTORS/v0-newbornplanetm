...
// Planet Motors Homepage Content - Client Component
              ...
              <div className="mt-8 p-4 bg-card rounded-xl border border-border">
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
                    ...
                    <p className="text-2xl font-semibold text-primary">{lowestRate}% APR</p>
                  </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-semibold">
              Why {siteSettings.dealerName} Wins
            </h2>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">
                    {siteSettings.dealerName} exceeds industry standards in inspection, financing, and customer service
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <div className="mt-4 flex items-center justify-center gap-2">
              ...
              <span className="text-muted-foreground">{ratingValue}/5 from {reviewCount}+ reviews</span>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-primary-foreground/10 rounded-xl p-6">
                ...
                <p className="text-sm text-primary-foreground/80 mt-1">{siteSettings.phone}</p>
              </div>
              <div className="bg-primary-foreground/10 rounded-xl p-6">
                <MapPin className="w-8 h-8 mb-4" />
                <h3 className="font-semibold">Visit Us</h3>
                <p className="text-sm text-primary-foreground/80 mt-1">{siteSettings.streetAddress}</p>
                <p className="text-sm text-primary-foreground/80">{siteSettings.city}, {siteSettings.province?.slice(0, 2)}</p>
              </div>
              <div className="bg-primary-foreground/10 rounded-xl p-6">
