...
export function LiveChatWidget() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-[60] flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-shadow min-h-[48px]"
      >
  ...
  return (
    <div
      className={cn(
        "fixed bottom-20 md:bottom-6 right-4 md:right-6 z-[60] bg-card border border-border rounded-xl shadow-2xl",
