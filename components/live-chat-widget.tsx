...
export function LiveChatWidget() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-[10000] flex items-center gap-2 bg-gradient-to-r from-[#1e3a5f] to-[#2d5a8e] text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-shadow min-h-[48px]"
      >
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-[#1e3a5f] to-[#2d5a8e] text-white rounded-t-xl">
